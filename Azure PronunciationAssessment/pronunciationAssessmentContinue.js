...
async function PronunciationAssessment(settings, fileName) {
    ...
    var reference_text = settings.reference_text;
    ...
    async function calculateOverallPronunciationScore() {
        ...
        const scores = {
            "Paragraph accuracy": scoreNumber.accuracyScore,
            "completeness": scoreNumber.compScore,
            "fluency": scoreNumber.fluencyScore
        }
...
exports.PronunciationAssessment = PronunciationAssessment;